...
class PreviewViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tblFoodItem.register(UINib(nibName: FoodItemTableViewCell.nibName, bundle: nil), forCellReuseIdentifier: FoodItemTableViewCell.reuseIdentifier)
...
extension PreviewViewController{
    ...
    func filterFood(category: Category) {
        filteredFood = foodItemList.filter {$0.foodCategory == category.Name}
        tblFoodItem.reloadData()
    }
...
extension PreviewViewController:UITableViewDataSource,UITableViewDelegate,FoodItemCellActions{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tblFoodItem.dequeueReusableCell(withIdentifier: FoodItemTableViewCell.reuseIdentifier, for: indexPath) as! FoodItemTableViewCell
